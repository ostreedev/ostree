...
for fs_type in ext4 vfat; do
    ...
    ${CMD_PREFIX} ostree --repo=peer-repo_$fs_type find-remotes --disable-avahi org.example.Collection1 test-1 > find-results
    ...
    ${CMD_PREFIX} ostree --repo=peer-repo_$fs_type find-remotes --disable-avahi --pull org.example.Collection1 test-1 > pull-results
