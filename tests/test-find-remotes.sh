...
for repo in local local-mirror; do
    ...
    ${CMD_PREFIX} ostree --repo=$repo find-remotes --disable-avahi org.example.AppsCollection app1 > find
    ...
    ${CMD_PREFIX} ostree --repo=$repo find-remotes --disable-avahi org.example.AppsCollection app1 org.example.OsCollection os/amd64/master > find
    assert_file_has_content find "^Result [0-9]\+: file://$(pwd)/apps-collection$"
    assert_file_has_content find "^ - Keyring: apps-remote.trustedkeys.gpg$"
    assert_file_has_content find "^    - (org.example.AppsCollection, app1) = $(cat app1-checksum)$"
    ...
    ${CMD_PREFIX} ostree --repo=$repo find-remotes --disable-avahi org.example.AppsCollection app1 org.example.AppsCollection app2 org.example.OsCollection os/amd64/master > find
    assert_file_has_content find "^Result [0-9]\+: file://$(pwd)/apps-collection$"
    assert_file_has_content find "^ - Keyring: apps-remote.trustedkeys.gpg$"
    assert_file_has_content find "^    - (org.example.AppsCollection, app1) = $(cat app1-checksum)$"
    ...
    ${CMD_PREFIX} ostree --repo=$repo find-remotes --disable-avahi org.example.AppsCollection app1 org.example.AppsCollection not-an-app > find
    assert_file_has_content find "^Result [0-9]\+: file://$(pwd)/apps-collection$"
    assert_file_has_content find "^ - Keyring: apps-remote.trustedkeys.gpg$"
    ...
    ${CMD_PREFIX} ostree --repo=$repo find-remotes --disable-avahi --pull org.example.AppsCollection app1 > pull || true
    ...
    ${CMD_PREFIX} ostree --repo=$repo find-remotes --disable-avahi --pull org.example.AppsCollection app1 org.example.OsCollection os/amd64/master > pull
    ...
    ${CMD_PREFIX} ostree --repo=$repo find-remotes --disable-avahi --pull org.example.AppsCollection app1 org.example.AppsCollection app2 org.example.OsCollection os/amd64/master > pull
    ...
    ${CMD_PREFIX} ostree --repo=$repo find-remotes --disable-avahi --pull org.example.AppsCollection app1 org.example.AppsCollection not-an-app > pull
...
for repo in local-mirror; do
    ...
    ${CMD_PREFIX} ostree --repo=$repo find-remotes --disable-avahi org.example.OsCollection os/amd64/master > find
    assert_file_has_content find "^Result [0-9]\+: file://$(pwd)/os-collection$"
    assert_file_has_content find "^ - Keyring: os-remote.trustedkeys.gpg$"
    ...
    # Pull it.
    ${CMD_PREFIX} ostree --repo=$repo find-remotes --disable-avahi --pull org.example.OsCollection os/amd64/master > pull || true
    assert_file_has_content pull "^1/1 refs were found.$"
    assert_file_has_content pull "^Pulled 1/1 refs successfully.$"
    assert_not_file_has_content pull "Failed to pull some refs from the remotes"
