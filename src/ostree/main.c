...
static OstreeCommand commands[] = {
  ...
  { "checkout", OSTREE_BUILTIN_FLAG_LOCKING,
  ...
  { "commit", OSTREE_BUILTIN_FLAG_LOCKING,
  ...
  { "diff", OSTREE_BUILTIN_FLAG_LOCKING,
    ostree_builtin_diff,
  ...
  { "gpg-sign", OSTREE_BUILTIN_FLAG_LOCKING,
  ...
  { "ls", OSTREE_BUILTIN_FLAG_NONE,
    ostree_builtin_ls,
    "List file paths" },
  { "prune", OSTREE_BUILTIN_FLAG_LOCKING,
    ostree_builtin_prune,
    "Search for unreachable objects" },
  { "pull-local", OSTREE_BUILTIN_FLAG_LOCKING,
    ostree_builtin_pull_local,
    "Copy data from SRC_REPO" },
#ifdef HAVE_LIBCURL_OR_LIBSOUP
  { "pull", OSTREE_BUILTIN_FLAG_LOCKING,
    ostree_builtin_pull,
  ...
  { "reset", OSTREE_BUILTIN_FLAG_LOCKING,
  ...
  { "summary", OSTREE_BUILTIN_FLAG_LOCKING,
