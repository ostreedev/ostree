...
static OstreeCommand admin_subcommands[] = {
  { "cleanup", OSTREE_BUILTIN_FLAG_NO_REPO | OSTREE_BUILTIN_FLAG_LOCKING,
  ...
  { "deploy", OSTREE_BUILTIN_FLAG_NO_REPO | OSTREE_BUILTIN_FLAG_LOCKING,
  ...
  { "status", OSTREE_BUILTIN_FLAG_NO_REPO,
    ...
    "List deployments" },
  { "switch", OSTREE_BUILTIN_FLAG_NO_REPO | OSTREE_BUILTIN_FLAG_LOCKING,
    ot_admin_builtin_switch,
    "Construct new tree from REF and deploy it" },
  { "undeploy", OSTREE_BUILTIN_FLAG_NO_REPO | OSTREE_BUILTIN_FLAG_LOCKING,
  ...
  { "upgrade", OSTREE_BUILTIN_FLAG_NO_REPO | OSTREE_BUILTIN_FLAG_LOCKING,
