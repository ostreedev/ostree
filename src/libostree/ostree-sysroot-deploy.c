...
bootloader_entry_filename (OstreeSysroot *sysroot, guint n_deployments,
                           OstreeDeployment *deployment, GCancellable *cancellable, GError **error)
{
...

{
  ...
  g_autofree char *bootconf_filename
      = bootloader_entry_filename (sysroot, n_deployments, deployment, cancellable, error);
  ...
  if (ostree_deployment_is_staged (deployment))
  ...
  else
    {
      ...
      g_autofree char *bootconf_filename = bootloader_entry_filename (
          self, self->deployments->len, deployment, cancellable, error);
