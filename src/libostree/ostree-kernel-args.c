 ...
 *
 * Returns: (transfer none): A newly created #OstreeKernelArgs for kernel arguments
 *
 * Since: 2019.3
 **/
OstreeKernelArgs *
 ...
 *
 * Atomically decrements the reference count of key array
 * and kargs table by one, and frees the kargs structure
 *
 * Since: 2019.3
 **/
void
 ...
 *
 * Returns: (transfer none): newly allocated #OstreeKernelArgs with @options appended
 *
 * Since: 2019.3
 **/
OstreeKernelArgs *
 ...
 * in @kargs is NULL
 *
 * Returns: (transfer full): an array of "key=value" paris or "key" if value is NULL
 *
 * Since: 2019.3
 **/
char **
 ...
 * in @kargs is NULL
 *
 * Returns: a string of "key=value" pairs or "key" if value is NULL, 
