 ...
 * ]|
 *
 * Returns: @repo on success, otherwise %NULL with @error set
 * Since: 2017.13
 */
OstreeRepoAutoLock *
 ...
 *
 * A cleanup handler for use with ostree_repo_auto_lock_push(). If @lock
 * is not %NULL, ostree_repo_lock_pop() will be called on it.
 *
 * Since: 2017.13
 */
void
