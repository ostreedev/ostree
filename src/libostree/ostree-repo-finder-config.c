 ...
 *
 * For all the locally configured remotes (see
 * [ostree.repo-config(5)](man:ostree.repo-config(5))), it finds the
 * intersection of their refs and the set of refs to resolve. If the
 * intersection is non-empty, that remote is returned as a result.
 *
 * Since: 2017.7
 */
