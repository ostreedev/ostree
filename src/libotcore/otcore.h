...
// This key is stored inside commit metadata.
#define OSTREE_SIGN_METADATA_X509_KEY "ostree.sign.x509"
// The variant type
#define OSTREE_SIGN_METADATA_X509_TYPE "aay"
...
bool otcore_x509_init (void);
gboolean otcore_validate_x509_signature (GBytes *data, GBytes *public_key, GBytes *signature,
                                         bool *out_valid, GError **error);
